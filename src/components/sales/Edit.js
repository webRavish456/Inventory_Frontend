...
const EditSales = ({ salesData, onClose, onSave }) => {
  ...
  useEffect(() => {
    if (salesData) {
      setFormData({
        ...
        customerEmail: salesData.customerEmail || "",
        customerPhone: salesData.customerPhone || "",
        orderDate: salesData.orderDate || "",
        deliveryDate: salesData.deliveryDate || "",
        totalAmount: salesData.totalAmount || "",
        paidAmount: salesData.paidAmount || "",
        paymentStatus: salesData.paymentStatus || "Pending",
        orderStatus: salesData.orderStatus || "Pending",
        paymentMethod: salesData.paymentMethod || "Cash",
        notes: salesData.notes || "",
        salesPerson: salesData.salesPerson || "",
        deliveryAddress: salesData.deliveryAddress || ""
      });
    }
  }, [salesData]);
